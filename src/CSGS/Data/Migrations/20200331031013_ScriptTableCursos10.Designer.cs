...
namespace CSGS.Data.Migrations
{
    ...
    [Migration("20200331031013_ScriptTableCursos10")]
    partial class ScriptTableCursos10
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CSGS.Models.Entities.CategoriaExt", b =>
                {
                    b.Property<int>("IdCategoriaExt")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("NombreCategoriaExt");

                    b.HasKey("IdCategoriaExt");

                    b.ToTable("CategoriaExt");
                });
            ...
            modelBuilder.Entity("CSGS.Models.Entities.CursoExt", b =>
                {
                    b.HasOne("CSGS.Models.Entities.CategoriaExt", "CategoriaExt")
                        .WithMany("CursoExt")
                        .HasForeignKey("IdCategoriaExt")
